...
- **Testing:** 29 automated tests (AppTest + pytest), bot dry-runs for abuse scenarios (prompt injection, mass token usage)
- **Recruitment:** Self-funded ($175 in participant raffles, $100 Reddit ad campaign with 32K impressions), multi-platform outreach (Reddit, LinkedIn, WhatsApp, Instagram)
- **Analysis:** Custom AI overlap scoring (trigram overlap, longest common substring, sequence matching), 6 stylometric features, 4 classifiers with SMOTE + stratified CV
